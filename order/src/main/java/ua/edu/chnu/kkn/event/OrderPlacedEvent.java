...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2745541188046483212L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlacedEvent\",\"namespace\":\"ua.edu.chnu.kkn.event\",\"fields\":[{\"name\":\"orderNumber\",\"type\":\"string\"}]}");
   ...
   */
  public static ua.edu.chnu.kkn.event.OrderPlacedEvent.Builder newBuilder() {
    return new ua.edu.chnu.kkn.event.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static ua.edu.chnu.kkn.event.OrderPlacedEvent.Builder newBuilder(ua.edu.chnu.kkn.event.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new ua.edu.chnu.kkn.event.OrderPlacedEvent.Builder();
    } else {
      return new ua.edu.chnu.kkn.event.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static ua.edu.chnu.kkn.event.OrderPlacedEvent.Builder newBuilder(ua.edu.chnu.kkn.event.OrderPlacedEvent other) {
    if (other == null) {
      return new ua.edu.chnu.kkn.event.OrderPlacedEvent.Builder();
    } else {
      return new ua.edu.chnu.kkn.event.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ua.edu.chnu.kkn.event.OrderPlacedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ua.edu.chnu.kkn.event.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderNumber)) {
        this.orderNumber = data().deepCopy(fields()[0].schema(), other.orderNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public ua.edu.chnu.kkn.event.OrderPlacedEvent.Builder setOrderNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ua.edu.chnu.kkn.event.OrderPlacedEvent.Builder clearOrderNumber() {
      orderNumber = null;
